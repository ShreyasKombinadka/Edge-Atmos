...
int main(void)
{
    ...
    while (1)
    {
        ...
        st7789lcd_print("EDGE ATMOS", 115, 10, 0xFFE0, 0xFFFF, 2, 12, 16, TFT_CS, TFT_CS_PORT, TFT_DC, TFT_DC_PORT);
        st7789lcd_print("0123456789", 40, 10, 0, 0xFFFF, 1, 12, 16, TFT_CS, TFT_CS_PORT, TFT_DC, TFT_DC_PORT);
    }
}
